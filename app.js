...
const Router = {
    ...
    return foods.map(food => `
      <section class="listing">
        ...
        <div class="listing-actions">
          ...
          <button class="listing-order-btn" onclick="Router.handleQuickOrder(${food.id})">Order Now</button>
        </div>
      </section>
    `).join('');
  },
  ...
  handleQuickOrder(id) {
    ...
    if (food) {
      const confirmed = confirm(`Add ${food.name} (₱${food.price.toFixed(2)}) to cart?`);
      if (confirmed) {
        alert(`✅ ${food.name} added to cart!\nPrice: ₱${food.price.toFixed(2)}\n\nYou can view your order in the details page.`);
      }
    }
  },
      ...
      <article>
        ...
        <section class="order-section">
          ...
          <div class="order-buttons">
            ...
            <button class="btn-add-cart" onclick="Router.handleAddToCart(${phFoods.id})">➕ Add to Cart</button>
  ...
  handleOrder(id) {
    ...
    if (food) {
      ...
      if (quantity && parseInt(quantity) > 0) {
        ...
        alert(`✅ Order Placed!\n\nItem: ${food.name}\nQuantity: ${qty}\nPrice per item: ₱${food.price.toFixed(2)}\nTotal: ₱${total.toFixed(2)}\n\nPlease fill out the contact form below to complete your order.`);
      }
    }
  },
